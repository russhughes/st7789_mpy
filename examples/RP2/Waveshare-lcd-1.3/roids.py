...
roid.py - Asteroids style game demo using polygons.
    Raspberry Pi PICO with a Waveshare Pico LCD 1.3
    Display Module.
...
def main():
    ...
    try:
        ...
        left = Pin(16,Pin.IN,Pin.PULL_UP)       # joystick left
        right = Pin(20,Pin.IN,Pin.PULL_UP)      # joystick right
        thrust = Pin(3,Pin.IN,Pin.PULL_UP)      # joystick center
        hyper = Pin(15,Pin.IN,Pin.PULL_UP)      # button A
        fire = Pin(21 ,Pin.IN,Pin.PULL_UP)      # button Y
